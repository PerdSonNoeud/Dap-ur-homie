    ...
    public static void register() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (inHug || inHuddle) {
                ...
                if (client.player.prevPitch != lockedHugPitch) client.player.prevPitch = lockedHugPitch;
                if (client.player.prevYaw   != lockedHugYaw)   client.player.prevYaw   = lockedHugYaw;
            } else {
